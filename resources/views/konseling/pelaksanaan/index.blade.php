...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 mb-2 mb-lg-0 font-weight-bold">Pelaksanaan Konseling</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Pelaksanaan Konseling</h6>
                </div>
                <div class="card-body">
...
@push('js')
    ...
    <script>
        ...
        $('#pelaksanaan-konseling').addClass('active');
    </script>
@endpush
