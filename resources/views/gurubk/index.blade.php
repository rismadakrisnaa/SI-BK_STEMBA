    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-hover table-striped" id="guru_bk_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex float-right">
                                            ...
                                            <button class="btn btn-sm btn-success mr-2" onclick="editData('{{$guru->_id}}')" data-toggle="modal" data-target="#guruBkModal">
